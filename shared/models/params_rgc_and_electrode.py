...
"""
Parameters describing a retinal ganglion cell and a patch clamp pipette.
"""

from brian2 import *

# Passive parameters
gL = .3* (siemens / meter ** 2)
Ri = 100. * ohm * cm

# Measured CGC parameters
Cm_tot = 50.*pF #3.* pF # cell capacitance
...
# Na channels parameters
gna_soma = 500. * (siemens / meter ** 2) 
gna_dend = 20. * (siemens / meter ** 2) 

# K channels parameters
gk_soma = 500. * (siemens / meter ** 2) 
