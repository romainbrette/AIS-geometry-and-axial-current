...
__all__ = ['cgc_and_electrode_model', 'cgc_and_series_resistance_model']

def cgc_and_electrode_model(params,  resting_vm = -90.*mV, Na_start = 5.*um, Na_end = 35.*um, density = False, gna_tot = 350.*nS, gk_tot = 150.*nS, gna_density = 4000.* (siemens / meter ** 2), morpho = None, i_inj = 0, Rs = 10*mohm):
    '''
...
def cgc_and_series_resistance_model(params,  resting_vm = -90.*mV, Na_start = 5.*um, Na_end = 35.*um, density = False, gna_tot = 350.*nS, gk_tot = 150.*nS, gna_density = 4000.* (siemens / meter ** 2), morpho = None, i_inj = 0, Rs = 10*mohm):
    '''
    If the morphology is not given, then it is created to a default.
    ...
    neuron = SpatialNeuron(morphology=morpho, model=eqs, Cm=Cm, Ri=Ri,
                                    namespace=dict(EL=EL, ENa=ENa, EK=EK,  soma_area=soma_area,
                                                   Ka=Ka, Va=Va, Taum_max=Taum_max,
                                                   Kh=Kh, Vh=Vh, Tauh_max=Tauh_max,
                                                   Kn=Kn, Vn=Vn, Taun_max=Taun_max,
                                                   Va_soma=Va_soma, 
