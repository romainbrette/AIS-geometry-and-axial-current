...
'''
Biophysical model of an AP with electrode.
...
__all__ = ['model_Na_Kv1_with_Rs']

def model_Na_Kv1_with_Rs(params,  resting_vm = -75.*mV, Na_start = 5.*um, Na_end = 35.*um, \
                 density = False, gna_tot = 350.*nS, gk_tot = 150.*nS, gL_soma = 1./(15000. * ohm * cm**2) , \
                 gna_density = 4000.* (siemens / meter ** 2), gk_density = 1500.* (siemens / meter ** 2), Rs = 0, morpho = None):
    '''
