...
### Figure
fig = figure('Threshold and current threshold', figsize=(6,2.5))
...
ax4.plot(linspace(-65, -50, 100), selected_currents[c][1][-1] * (1-sqrt((1./slope_linreg[c][1]) * (selected_voltages[c][1][-1] - linspace(-65, -50, 100)))), color='gray' )
...
ax4.set_xlim(-66,-56)
ax4.annotate("B", xy=(0,1.1), xycoords="axes fraction",
                    xytext=(5,-5), textcoords="offset points",
                    ha="left", va="top",
                    fontsize=12, weight='bold')
...
# ax5.annotate("D", xy=(0,1.1), xycoords="axes fraction",
#                     xytext=(5,-5), textcoords="offset points",
#                     ha="left", va="top",
#                     fontsize=12, weight='bold')
...
slope_mod2, intercept_mod2, _, _, _ = stats.linregress(-IV_i_below[-5:]**2, IV_vc_below[-5:],)
...
ax7.plot(linspace(-70, -60, 100), IV_i_below[-1] * (1-sqrt((1/slope_mod) * (IV_vc_below[-1] - linspace(-70, -60, 100)))), color='g' )
...
# ax8.annotate("C", xy=(0,1.1), xycoords="axes fraction",
#                     xytext=(5,-5), textcoords="offset points",
#                     ha="left", va="top",
#                     fontsize=12, weight='bold')
...
# fig.savefig(save_path + "fig6_bis.pdf", bbox_inches='tight')

# fig.savefig(save_path + "fig6_bis.png", dpi=300)
